...
### 4. Check the Applied Floorplan Configuration
...
### 5. Verify Component/Net Counts via OpenROAD Log
...
- Click left, then right → forms a box (defines a region)
